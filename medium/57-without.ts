...
type Without<
  ...
  TFormattedU = U extends number ? U : U extends number[] ? U[number] : never
> = T extends [infer IFirst, ...infer IRest extends number[]]
  ? IFirst extends TFormattedU
    ? Without<IRest, U>
    : [IFirst, ...Without<IRest, U>]
  : T;
