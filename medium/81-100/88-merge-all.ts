...
type MergeAll<
  TTuple extends object[],
  TResult extends object = {}
> = TTuple extends [infer IFirst, ...infer IRest extends object[]]
  ? MergeAll<
      IRest,
      Omit<TResult, keyof IFirst> & {
        [Key in keyof IFirst]: Key extends keyof TResult
          ? TResult[Key] | IFirst[Key]
          : IFirst[Key];
      }
    >
  : Omit<TResult, never>; // Joins all the `&` intersections as one type

type Test = MergeAll<[{ a: 1; b: 2 }, { a: 2 }, { c: 3 }]>;
//   ^?
