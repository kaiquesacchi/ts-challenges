...
type NumberRange<
  TStart,
  TEnd,
  TTuple extends number[] = [],
  TCount extends true[] = [],
  TStarted extends boolean = false
> = TStarted extends false
  ? TCount["length"] extends TStart
    ? NumberRange<TStart, TEnd, [TCount["length"]], [...TCount, true], true>
    : NumberRange<TStart, TEnd, TTuple, [...TCount, true], false>
  : TCount["length"] extends TEnd
  ? TTuple[number] | TCount["length"]
  : NumberRange<
      TStart,
      TEnd,
      [...TTuple, TCount["length"]],
      [...TCount, true],
      true
    >;
